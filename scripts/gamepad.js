...
var gamepadBtn = [
    ...
    {imgID: "imgBGDPad", draw: true, touchEnable: false, name: "dpad_pos_bg", x: 155, y: 60, w: 462, h: 462},
    {imgID: "imgDPadNormal", draw: true, touchEnable: false, name: "dpad_pos", x: 200, y: 100, w: 380, h: 380},
    {imgID: "", draw: false, touchEnable: true, name: "dpad_left", keyCode: KEYCODE_DPAD_LEFT, x: 200, y: 230, w: 130, h: 120},
    {imgID: "", draw: false, touchEnable: true, name: "dpad_right", keyCode: KEYCODE_DPAD_RIGHT, x: 450, y: 230, w: 130, h: 120},
    {imgID: "", draw: false, touchEnable: true, name: "dpad_up", keyCode: KEYCODE_DPAD_UP, x: 330, y: 100, w: 120, h: 130},
    {imgID: "", draw: false, touchEnable: true, name: "dpad_down", keyCode: KEYCODE_DPAD_DOWN, x: 330, y: 350, w: 120, h: 130},
    {imgID: "imgL", draw: true, touchEnable: true, name: "trigger_l", keyCode: KEYCODE_BUTTON_L1, x: 28, y: 458, w: 115, h: 224},
    {imgID: "imgR", draw: true, touchEnable: true, name: "trigger_r", keyCode: KEYCODE_BUTTON_R1, x: 1773, y: 458, w: 115, h: 224},

    //Keycode for press/release, touch enable?, name, x, y, w, h, xR, yR
    {imgID: "imgX", draw: true, touchEnable: true, name: "button_x", keyCode: KEYCODE_BUTTON_X, x: 1168, y: 204, w: 224, h: 224, xR: 1280, yR: 316},
    {imgID: "imgY", draw: true, touchEnable: true, name: "button_y", keyCode: KEYCODE_BUTTON_Y, x: 1355, y: 48, w: 224, h: 224, xR: 1467, yR: 160},
    {imgID: "imgA", draw: true, touchEnable: true, name: "button_a", keyCode: KEYCODE_BUTTON_A, x: 1355, y: 360, w: 224, h: 224, xR: 1467, yR: 472},
    {imgID: "imgB", draw: true, touchEnable: true, name: "button_b", keyCode: KEYCODE_BUTTON_B, x: 1536, y: 204, w: 224, h: 224, xR: 1648, yR: 316},
    {imgID: "imgBack", draw: true, touchEnable: true, name: "button_back", keyCode: KEYCODE_BUTTON_SELECT, x: 870, y: 480, w: 180, h: 180, xR: 960, yR: 570},
    {imgID: "imgBGMove", draw: true, touchEnable: false, name: "button_axis_left_bg", x: 350, y: 570, w: 464, h: 464, xR: 582, yR: 802},
    {imgID: "imgBGMove", draw: true, touchEnable: false, name: "button_axis_right_bg", x: 1096, y: 570, w: 464, h: 464, xR: 1328, yR: 802},
    {imgID: "imgControll", draw: true, touchEnable: false, name: "button_axis_left", keyCode: 0, x: 449, y: 669, w: 266, h: 266, xR: 582, yR: 802},
    {imgID: "imgControll", draw: true, touchEnable: false, name: "button_axis_right", keyCode: 0, x: 1195, y: 669, w: 266, h: 266, xR: 1328, yR: 802},
];
